...
It seems that the average maximum temperature for both January and July
are oscillating on a 2-year cycle. One can also argue that there is a
slight increase from 1980 to 2010. More extreme values; also some
outliers;
...
tmin_tmax = weather_df %>% 
  ...
  theme(legend.position = "right") +
    labs(
      title = "Maximum and Minimum Temperature of New York State in Years 1981 to 2010",
...
snowfall_dist = weather_df %>% 
  ...
  labs(
      title = "Snowfall Values (mm) in New York from 1981 to 2010",
    x = "Snowfall (mm)",
    y = "Year") +
   scale_x_continuous(
...
<img src="p8105_hw3_yc4017_files/figure-gfm/unnamed-chunk-13-1.png" width="90%" />
